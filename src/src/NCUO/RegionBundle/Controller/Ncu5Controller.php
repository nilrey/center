 ...
 * Ncu5  controller.
 */
class Ncu5Controller extends Controller
{
    ...
    private $pageTitle = 'НЦУ/5. Сведения о ходе создания парка «Патриот»';
    ...
    public function showAction($id_reg)
    {
        ...
        $arResult['urlEdit'] = $this->generateUrl('ncu5_edit', array('id_reg'=>$id_reg ));
    ...
    /**
     *
     * @Route("/{id_reg}/ncu5/edit", name="ncu5_edit")
     * @Method("GET")
    ...
    /**
     *
     * @Route("/{id_reg}/ncu5/export", name="ncu5_export")
     * @Method("GET")
     * @Template("ncuoregion/item_edit.html.twig")
     */
    ...
    /**
     *
     * @Route("/{id_reg}/ncu5/import", name="ncu5_import")
     * @Method("GET")
     * @Template("ncuoregion/item_edit.html.twig")
     */
    ...
    /**
     * Update data
     * @Route("/{id_reg}/ncu5/update", name="ncu5_update")
     * @Method("POST")
     * @Template("ncuoregion/item_edit.html.twig")
     */
    ...
    {     
        ...
        $urlAction = $this->generateUrl('ncu5_update', array('id_reg'=>$region[0]->getId() ));
        $urlView = $this->generateUrl('ncu5_edit', array('id_reg'=>$region[0]->getId() ));
        $urlBack = $this->generateUrl('ncu5', array('id_reg'=>$region[0]->getId() ));
