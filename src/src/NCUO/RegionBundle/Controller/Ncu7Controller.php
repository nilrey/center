 ...
 * Ncu7  controller.
 */
class Ncu7Controller extends Controller
{
    ...
    private $pageTitle = 'НЦУ/7. Сведения по основным региональным автомобильным дорогам';
    ...
    public function showAction($id_reg)
    {
        ...
        $arResult['urlEdit'] = $this->generateUrl('ncu7_edit', array('id_reg'=>$id_reg ));
    ...
    /**
     *
     * @Route("/{id_reg}/ncu7/edit", name="ncu7_edit")
     * @Method("GET")
    ...
    /**
     *
     * @Route("/{id_reg}/ncu7/export", name="ncu7_export")
     * @Method("GET")
     * @Template("ncuoregion/item_edit.html.twig")
     */
    ...
    /**
     *
     * @Route("/{id_reg}/ncu7/import", name="ncu7_import")
     * @Method("GET")
     * @Template("ncuoregion/item_edit.html.twig")
     */
    ...
    /**
     * Update data
     * @Route("/{id_reg}/ncu7/update", name="ncu7_update")
     * @Method("POST")
     * @Template("ncuoregion/item_edit.html.twig")
     */
    ...
    {     
        ...
        $urlAction = $this->generateUrl('ncu7_update', array('id_reg'=>$region[0]->getId() ));
        $urlView = $this->generateUrl('ncu7_edit', array('id_reg'=>$region[0]->getId() ));
        $urlBack = $this->generateUrl('ncu7', array('id_reg'=>$region[0]->getId() ));
