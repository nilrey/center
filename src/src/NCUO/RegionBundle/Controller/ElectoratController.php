...
/**
 * Electorat  controller.
 */
class ElectoratController extends Controller
{
    
    const SEC_ID = "s_electorat";
    ...
    private $pageTitle = 'Электоральная характеристика';
     ...
     *
     * @Route("/{id_reg}/s_electorat", name="s_electorat")
     * @Method("GET")
...
//        $sections = $em->getRepository('NCUOOivBundle:Section')->findBy(array('id_sec' => $id_reg.'__short_info'), array('view_order' => 'ASC'), null , null );
  ...
  //echo '<pre>',print_r($fields[0]),'</pre>';
        ...
        return array(
            ...
            'urlEdit' => $this->generateUrl('s_electorat_edit', array('id_reg'=>$region[0]->getId() )),
            'tabmenu' => $tabMenu,
    ...
    /**
     *
     * @Route("/{id_reg}/s_electorat/edit", name="s_electorat_edit")
     * @Method("GET")
    ...
    /**
     * Update data
     * @Route("/{id_reg}/s_electorat/update", name="s_electorat_update")
     * @Method("POST")
     * @Template("ncuoregion/item_edit.html.twig")
     */
    ...
    {     
        ...
        $urlAction = $this->generateUrl('s_electorat_update', array('id_reg'=>$region[0]->getId() ));
        $urlView = $this->generateUrl('s_electorat_edit', array('id_reg'=>$region[0]->getId() ));
        $urlBack = $this->generateUrl('s_electorat', array('id_reg'=>$region[0]->getId() ));
