...
class CommunicationController extends Controller
{
    ...
    private $pageTitle = 'Транспорт и связь';
     ...
     *
     * @Route("/{id_reg}/s_communication", name="s_communication")
     * @Method("GET")
...
//        $sections = $em->getRepository('NCUOOivBundle:Section')->findBy(array('id_sec' => $id_reg.'__short_info'), array('view_order' => 'ASC'), null , null );
  ...
  //echo '<pre>',print_r($fields[0]),'</pre>';
        ...
        return array(
            ...
            'urlEdit' => $this->generateUrl('s_communication_edit', array('id_reg'=>$region[0]->getId() )),
            'tabmenu' => $tabMenu,
    ...
    /**
     *
     * @Route("/{id_reg}/s_communication/edit", name="s_communication_edit")
     * @Method("GET")
    ...
    /**
     * Update data
     * @Route("/{id_reg}/s_communication/update", name="s_communication_update")
     * @Method("POST")
     * @Template("ncuoregion/item_edit.html.twig")
     */
    ...
    {     
        ...
        $urlAction = $this->generateUrl('s_communication_update', array('id_reg'=>$region[0]->getId() ));
        $urlView = $this->generateUrl('s_communication_edit', array('id_reg'=>$region[0]->getId() ));
        $urlBack = $this->generateUrl('s_communication', array('id_reg'=>$region[0]->getId() ));
