 ...
 * Ncu9  controller.
 */
class Ncu9Controller extends Controller
{
    ...
    private $pageTitle = 'НЦУ/9. Данные по железнодорожной инфраструктуре';
    ...
    public function showAction($id_reg)
    {
        ...
        $arResult['urlEdit'] = $this->generateUrl('ncu9_edit', array('id_reg'=>$id_reg ));
    ...
    /**
     *
     * @Route("/{id_reg}/ncu9/edit", name="ncu9_edit")
     * @Method("GET")
    ...
    /**
     *
     * @Route("/{id_reg}/ncu9/export", name="ncu9_export")
     * @Method("GET")
     * @Template("ncuoregion/item_edit.html.twig")
     */
    ...
    /**
     *
     * @Route("/{id_reg}/ncu9/import", name="ncu9_import")
     * @Method("GET")
     * @Template("ncuoregion/item_edit.html.twig")
     */
    ...
    /**
     * Update data
     * @Route("/{id_reg}/ncu9/update", name="ncu9_update")
     * @Method("POST")
     * @Template("ncuoregion/item_edit.html.twig")
     */
    ...
    {     
        ...
        $urlAction = $this->generateUrl('ncu9_update', array('id_reg'=>$region[0]->getId() ));
        $urlView = $this->generateUrl('ncu9_edit', array('id_reg'=>$region[0]->getId() ));
        $urlBack = $this->generateUrl('ncu9', array('id_reg'=>$region[0]->getId() ));
