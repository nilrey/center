...
class InvestmentsController extends Controller
{
    ...
    private $pageTitle = 'Инвестиции в основной капитал';
     ...
     *
     * @Route("/{id_reg}/s_investments", name="s_investments")
     * @Method("GET")
...
//        $sections = $em->getRepository('NCUOOivBundle:Section')->findBy(array('id_sec' => $id_reg.'__short_info'), array('view_order' => 'ASC'), null , null );
  ...
  //echo '<pre>',print_r($fields[0]),'</pre>';
        ...
        return array(
            ...
            'urlEdit' => $this->generateUrl('s_investments_edit', array('id_reg'=>$region[0]->getId() )),
            'tabmenu' => $tabMenu,
    ...
    /**
     *
     * @Route("/{id_reg}/s_investments/edit", name="s_investments_edit")
     * @Method("GET")
    ...
    /**
     * Update data
     * @Route("/{id_reg}/s_investments/update", name="s_investments_update")
     * @Method("POST")
     * @Template("ncuoregion/item_edit.html.twig")
     */
    ...
    {     
        ...
        $urlAction = $this->generateUrl('s_investments_update', array('id_reg'=>$region[0]->getId() ));
        $urlView = $this->generateUrl('s_investments_edit', array('id_reg'=>$region[0]->getId() ));
        $urlBack = $this->generateUrl('s_investments', array('id_reg'=>$region[0]->getId() ));
