...
class HousingConditionsController extends Controller
{
    ...
    const SEC_ID = "s_housing_conditions";
    ...
    private $pageTitle = 'Жилищные условия населения';
     ...
     *
     * @Route("/{id_reg}/s_housing_conditions", name="s_housing_conditions")
     * @Method("GET")
...
//        $sections = $em->getRepository('NCUOOivBundle:Section')->findBy(array('id_sec' => $id_reg.'__short_info'), array('view_order' => 'ASC'), null , null );
  ...
  //echo '<pre>',print_r($fields[0]),'</pre>';
        ...
        return array(
            ...
            'urlEdit' => $this->generateUrl('s_housing_conditions_edit', array('id_reg'=>$region[0]->getId() )),
            'tabmenu' => $tabMenu,
    ...
    /**
     *
     * @Route("/{id_reg}/s_housing_conditions/edit", name="s_housing_conditions_edit")
     * @Method("GET")
    ...
    /**
     * Update data
     * @Route("/{id_reg}/s_housing_conditions/update", name="s_housing_conditions_update")
     * @Method("POST")
     * @Template("ncuoregion/item_edit.html.twig")
     */
    ...
    {     
        ...
        $urlAction = $this->generateUrl('s_housing_conditions_update', array('id_reg'=>$region[0]->getId() ));
        $urlView = $this->generateUrl('s_housing_conditions_edit', array('id_reg'=>$region[0]->getId() ));
        $urlBack = $this->generateUrl('s_housing_conditions', array('id_reg'=>$region[0]->getId() ));
