...
class BankingController extends Controller
{
    ...
    private $pageTitle = 'Банковская система';
     ...
     *
     * @Route("/{id_reg}/s_banking", name="s_banking")
     * @Method("GET")
...
//        $sections = $em->getRepository('NCUOOivBundle:Section')->findBy(array('id_sec' => $id_reg.'__short_info'), array('view_order' => 'ASC'), null , null );
  ...
  //echo '<pre>',print_r($fields[0]),'</pre>';
        ...
        return array(
            ...
            'urlEdit' => $this->generateUrl('s_banking_edit', array('id_reg'=>$region[0]->getId() )),
            'tabmenu' => $tabMenu,
    ...
    /**
     *
     * @Route("/{id_reg}/s_banking/edit", name="s_banking_edit")
     * @Method("GET")
    ...
    /**
     * Update data
     * @Route("/{id_reg}/s_banking/update", name="s_banking_update")
     * @Method("POST")
     * @Template("ncuoregion/item_edit.html.twig")
     */
    ...
    {     
        ...
        $urlAction = $this->generateUrl('s_banking_update', array('id_reg'=>$region[0]->getId() ));
        $urlView = $this->generateUrl('s_banking_edit', array('id_reg'=>$region[0]->getId() ));
        $urlBack = $this->generateUrl('s_banking', array('id_reg'=>$region[0]->getId() ));
