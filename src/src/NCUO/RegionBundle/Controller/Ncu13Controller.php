 ...
 * Ncu13  controller.
 */
class Ncu13Controller extends Controller
{
    ...
    private $pageTitle = 'НЦУ/13. Сведения о состоянии объектов, обеспечивающих жизнедеятельность населения, функционирование транспорта, коммуникаций и связи, объектов энергетики, а также объектов, представляющих повышенную опасность для жизни и здоровья людей и окружающей природной среды';
    ...
    public function showAction($id_reg)
    {
        ...
        $arResult['urlEdit'] = $this->generateUrl('ncu13_edit', array('id_reg'=>$id_reg ));
    ...
    /**
     *
     * @Route("/{id_reg}/ncu13/edit", name="ncu13_edit")
     * @Method("GET")
    ...
    /**
     *
     * @Route("/{id_reg}/ncu13/export", name="ncu13_export")
     * @Method("GET")
     * @Template("ncuoregion/item_edit.html.twig")
     */
    ...
    /**
     *
     * @Route("/{id_reg}/ncu13/import", name="ncu13_import")
     * @Method("GET")
     * @Template("ncuoregion/item_edit.html.twig")
     */
    ...
    /**
     * Update data
     * @Route("/{id_reg}/ncu13/update", name="ncu13_update")
     * @Method("POST")
     * @Template("ncuoregion/item_edit.html.twig")
     */
    ...
    {     
        ...
        $urlAction = $this->generateUrl('ncu13_update', array('id_reg'=>$region[0]->getId() ));
        $urlView = $this->generateUrl('ncu13_edit', array('id_reg'=>$region[0]->getId() ));
        $urlBack = $this->generateUrl('ncu13', array('id_reg'=>$region[0]->getId() ));
