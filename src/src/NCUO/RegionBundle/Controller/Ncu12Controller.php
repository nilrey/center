 ...
 * Ncu12  controller.
 */
class Ncu12Controller extends Controller
{
    ...
    private $pageTitle = 'НЦУ/12. Сведения о составе органов исполнительной власти субъекта Российской Федерации и органов местного самоуправления';
    ...
    public function showAction($id_reg)
    {
        ...
        $arResult['urlEdit'] = $this->generateUrl('ncu12_edit', array('id_reg'=>$id_reg ));
    ...
    /**
     *
     * @Route("/{id_reg}/ncu12/edit", name="ncu12_edit")
     * @Method("GET")
    ...
    /**
     *
     * @Route("/{id_reg}/ncu12/export", name="ncu12_export")
     * @Method("GET")
     * @Template("ncuoregion/item_edit.html.twig")
     */
    ...
    /**
     *
     * @Route("/{id_reg}/ncu12/import", name="ncu12_import")
     * @Method("GET")
     * @Template("ncuoregion/item_edit.html.twig")
     */
    ...
    /**
     * Update data
     * @Route("/{id_reg}/ncu12/update", name="ncu12_update")
     * @Method("POST")
     * @Template("ncuoregion/item_edit.html.twig")
     */
    ...
    {     
        ...
        $urlAction = $this->generateUrl('ncu12_update', array('id_reg'=>$region[0]->getId() ));
        $urlView = $this->generateUrl('ncu12_edit', array('id_reg'=>$region[0]->getId() ));
        $urlBack = $this->generateUrl('ncu12', array('id_reg'=>$region[0]->getId() ));
