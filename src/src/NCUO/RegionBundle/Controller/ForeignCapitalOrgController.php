...
/**
 * ForeignCapitalOrg  controller.
 */
class ForeignCapitalOrgController extends Controller
{
    
    const SEC_ID = "s_foreign_capital_org";
    ...
    private $pageTitle = 'Организации с участием иностранного капитала';
     ...
     *
     * @Route("/{id_reg}/s_foreign_capital_org", name="s_foreign_capital_org")
     * @Method("GET")
...
//        $sections = $em->getRepository('NCUOOivBundle:Section')->findBy(array('id_sec' => $id_reg.'__short_info'), array('view_order' => 'ASC'), null , null );
  ...
  //echo '<pre>',print_r($fields[0]),'</pre>';
        ...
        return array(
            ...
            'urlEdit' => $this->generateUrl('s_foreign_capital_org_edit', array('id_reg'=>$region[0]->getId() )),
            'tabmenu' => $tabMenu,
    ...
    /**
     *
     * @Route("/{id_reg}/s_foreign_capital_org/edit", name="s_foreign_capital_org_edit")
     * @Method("GET")
    ...
    /**
     * Update data
     * @Route("/{id_reg}/s_foreign_capital_org/update", name="s_foreign_capital_org_update")
     * @Method("POST")
     * @Template("ncuoregion/item_edit.html.twig")
     */
    ...
    {     
        ...
        $urlAction = $this->generateUrl('s_foreign_capital_org_update', array('id_reg'=>$region[0]->getId() ));
        $urlView = $this->generateUrl('s_foreign_capital_org_edit', array('id_reg'=>$region[0]->getId() ));
        $urlBack = $this->generateUrl('s_foreign_capital_org', array('id_reg'=>$region[0]->getId() ));
