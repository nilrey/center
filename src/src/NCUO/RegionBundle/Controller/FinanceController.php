...
class FinanceController extends Controller
{
    ...
    private $pageTitle = 'Внешнеэкономическая деятельность';
     ...
     *
     * @Route("/{id_reg}/s_finance", name="s_finance")
     * @Method("GET")
...
//        $sections = $em->getRepository('NCUOOivBundle:Section')->findBy(array('id_sec' => $id_reg.'__short_info'), array('view_order' => 'ASC'), null , null );
  ...
  //echo '<pre>',print_r($fields[0]),'</pre>';
        ...
        return array(
            ...
            'urlEdit' => $this->generateUrl('s_finance_edit', array('id_reg'=>$region[0]->getId() )),
            'tabmenu' => $tabMenu,
    ...
    /**
     *
     * @Route("/{id_reg}/s_finance/edit", name="s_finance_edit")
     * @Method("GET")
    ...
    /**
     * Update data
     * @Route("/{id_reg}/s_finance/update", name="s_finance_update")
     * @Method("POST")
     * @Template("ncuoregion/item_edit.html.twig")
     */
    ...
    {     
        ...
        $urlAction = $this->generateUrl('s_finance_update', array('id_reg'=>$region[0]->getId() ));
        $urlView = $this->generateUrl('s_finance_edit', array('id_reg'=>$region[0]->getId() ));
        $urlBack = $this->generateUrl('s_finance', array('id_reg'=>$region[0]->getId() ));
