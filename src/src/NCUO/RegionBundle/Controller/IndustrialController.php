...
class IndustrialController extends Controller
{
    ...
    private $pageTitle = 'Промышленное производство';
     ...
     *
     * @Route("/{id_reg}/s_industrial", name="s_industrial")
     * @Method("GET")
...
//        $sections = $em->getRepository('NCUOOivBundle:Section')->findBy(array('id_sec' => $id_reg.'__short_info'), array('view_order' => 'ASC'), null , null );
  ...
  //echo '<pre>',print_r($fields[0]),'</pre>';
        ...
        return array(
            ...
            'urlEdit' => $this->generateUrl('s_industrial_edit', array('id_reg'=>$region[0]->getId() )),
            'tabmenu' => $tabMenu,
    ...
    /**
     *
     * @Route("/{id_reg}/s_industrial/edit", name="s_industrial_edit")
     * @Method("GET")
    ...
    /**
     * Update data
     * @Route("/{id_reg}/s_industrial/update", name="s_industrial_update")
     * @Method("POST")
     * @Template("ncuoregion/item_edit.html.twig")
     */
    ...
    {     
        ...
        $urlAction = $this->generateUrl('s_industrial_update', array('id_reg'=>$region[0]->getId() ));
        $urlView = $this->generateUrl('s_industrial_edit', array('id_reg'=>$region[0]->getId() ));
        $urlBack = $this->generateUrl('s_industrial', array('id_reg'=>$region[0]->getId() ));
