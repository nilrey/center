 ...
 * Ncu4  controller.
 */
class Ncu4Controller extends Controller
{
    ...
    private $pageTitle = 'НЦУ/4. Сведения об основных мероприятиях военно-патриотической направленности, проведенных за прошедший и планируемых на предстоящий месяц';
    ...
    public function showAction($id_reg)
    {
        ...
        $arResult['urlEdit'] = $this->generateUrl('ncu4_edit', array('id_reg'=>$id_reg ));
    ...
    /**
     *
     * @Route("/{id_reg}/ncu4/edit", name="ncu4_edit")
     * @Method("GET")
    ...
    /**
     *
     * @Route("/{id_reg}/ncu4/export", name="ncu4_export")
     * @Method("GET")
     * @Template("ncuoregion/item_edit.html.twig")
     */
    ...
    /**
     *
     * @Route("/{id_reg}/ncu4/import", name="ncu4_import")
     * @Method("GET")
     * @Template("ncuoregion/item_edit.html.twig")
     */
    ...
    /**
     * Update data
     * @Route("/{id_reg}/ncu4/update", name="ncu4_update")
     * @Method("POST")
     * @Template("ncuoregion/item_edit.html.twig")
     */
    ...
    {     
        ...
        $urlAction = $this->generateUrl('ncu4_update', array('id_reg'=>$region[0]->getId() ));
        $urlView = $this->generateUrl('ncu4_edit', array('id_reg'=>$region[0]->getId() ));
        $urlBack = $this->generateUrl('ncu4', array('id_reg'=>$region[0]->getId() ));
