...
/**
 * SituationRating  controller.
 */
class SituationRatingController extends Controller
{
    
    const SEC_ID = "s_situation_rating";
    ...
    private $pageTitle = 'Оценка населением ситуации в регионе';
     ...
     *
     * @Route("/{id_reg}/s_situation_rating", name="s_situation_rating")
     * @Method("GET")
...
//        $sections = $em->getRepository('NCUOOivBundle:Section')->findBy(array('id_sec' => $id_reg.'__short_info'), array('view_order' => 'ASC'), null , null );
  ...
  //echo '<pre>',print_r($fields[0]),'</pre>';
        ...
        return array(
            ...
            'urlEdit' => $this->generateUrl('s_situation_rating_edit', array('id_reg'=>$region[0]->getId() )),
            'tabmenu' => $tabMenu,
    ...
    /**
     *
     * @Route("/{id_reg}/s_situation_rating/edit", name="s_situation_rating_edit")
     * @Method("GET")
    ...
    /**
     * Update data
     * @Route("/{id_reg}/s_situation_rating/update", name="s_situation_rating_update")
     * @Method("POST")
     * @Template("ncuoregion/item_edit.html.twig")
     */
    ...
    {     
        ...
        $urlAction = $this->generateUrl('s_situation_rating_update', array('id_reg'=>$region[0]->getId() ));
        $urlView = $this->generateUrl('s_situation_rating_edit', array('id_reg'=>$region[0]->getId() ));
        $urlBack = $this->generateUrl('s_situation_rating', array('id_reg'=>$region[0]->getId() ));
