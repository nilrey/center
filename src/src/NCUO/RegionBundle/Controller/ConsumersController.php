...
class ConsumersController extends Controller
{
    ...
    private $pageTitle = 'Потребительский рынок';
     ...
     *
     * @Route("/{id_reg}/s_consumers", name="s_consumers")
     * @Method("GET")
...
//        $sections = $em->getRepository('NCUOOivBundle:Section')->findBy(array('id_sec' => $id_reg.'__short_info'), array('view_order' => 'ASC'), null , null );
  ...
  //echo '<pre>',print_r($fields[0]),'</pre>';
        ...
        return array(
            ...
            'urlEdit' => $this->generateUrl('s_consumers_edit', array('id_reg'=>$region[0]->getId() )),
            'tabmenu' => $tabMenu,
    ...
    /**
     *
     * @Route("/{id_reg}/s_consumers/edit", name="s_consumers_edit")
     * @Method("GET")
    ...
    /**
     * Update data
     * @Route("/{id_reg}/s_consumers/update", name="s_consumers_update")
     * @Method("POST")
     * @Template("ncuoregion/item_edit.html.twig")
     */
    ...
    {     
        ...
        $urlAction = $this->generateUrl('s_consumers_update', array('id_reg'=>$region[0]->getId() ));
        $urlView = $this->generateUrl('s_consumers_edit', array('id_reg'=>$region[0]->getId() ));
        $urlBack = $this->generateUrl('s_consumers', array('id_reg'=>$region[0]->getId() ));
