 ...
 * Ncu2  controller.
 */
class Ncu2Controller extends Controller
{
    ...
    private $pageTitle = 'НЦУ/2. Сведения о количестве членов семей военнослужащих, зарегистрированных в центрах занятости для поиска работы';
    ...
    public function showAction($id_reg)
    {
        ...
        $arResult['urlEdit'] = $this->generateUrl('ncu2_edit', array('id_reg'=>$id_reg ));
    ...
    /**
     *
     * @Route("/{id_reg}/ncu2/edit", name="ncu2_edit")
     * @Method("GET")
    ...
    /**
     *
     * @Route("/{id_reg}/ncu2/export", name="ncu2_export")
     * @Method("GET")
     * @Template("ncuoregion/item_edit.html.twig")
     */
    ...
    /**
     *
     * @Route("/{id_reg}/ncu2/import", name="ncu2_import")
     * @Method("GET")
     * @Template("ncuoregion/item_edit.html.twig")
     */
    ...
    /**
     * Update data
     * @Route("/{id_reg}/ncu2/update", name="ncu2_update")
     * @Method("POST")
     * @Template("ncuoregion/item_edit.html.twig")
     */
    ...
    {     
        ...
        $urlAction = $this->generateUrl('ncu2_update', array('id_reg'=>$region[0]->getId() ));
        $urlView = $this->generateUrl('ncu2_edit', array('id_reg'=>$region[0]->getId() ));
        $urlBack = $this->generateUrl('ncu2', array('id_reg'=>$region[0]->getId() ));
