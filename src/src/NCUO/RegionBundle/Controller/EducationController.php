...
class EducationController extends Controller
{
     ...
     *
     * @Route("/{id_reg}/s_education", name="s_education")
     * @Method("GET")
...
//        $sections = $em->getRepository('NCUOOivBundle:Section')->findBy(array('id_sec' => $id_reg.'__short_info'), array('view_order' => 'ASC'), null , null );
  ...
  //echo '<pre>',print_r($fields[0]),'</pre>';
        ...
        return array(
            ...
            'urlEdit' => $this->generateUrl('s_education_edit', array('id_reg'=>$region[0]->getId() )),
            'tabmenu' => $tabMenu,
    ...
    /**
     *
     * @Route("/{id_reg}/s_education/edit", name="s_education_edit")
     * @Method("GET")
    ...
    /**
     * Update data
     * @Route("/{id_reg}/s_education/update", name="s_education_update")
     * @Method("POST")
     * @Template("ncuoregion/item_edit.html.twig")
     */
    ...
    {     
        ...
        $urlAction = $this->generateUrl('s_education_update', array('id_reg'=>$region[0]->getId() ));
        $urlView = $this->generateUrl('s_education_edit', array('id_reg'=>$region[0]->getId() ));
        $urlBack = $this->generateUrl('s_education', array('id_reg'=>$region[0]->getId() ));
