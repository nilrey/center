...
/**
 * LivingConditions  controller.
 */
class LivingConditionsController extends Controller
{
    
    const SEC_ID = "s_living_conditions";
    ...
    private $pageTitle = 'Уровень жизни населения';
     ...
     *
     * @Route("/{id_reg}/s_living_conditions", name="s_living_conditions")
     * @Method("GET")
...
//        $sections = $em->getRepository('NCUOOivBundle:Section')->findBy(array('id_sec' => $id_reg.'__short_info'), array('view_order' => 'ASC'), null , null );
  ...
  //echo '<pre>',print_r($fields[0]),'</pre>';
        ...
        return array(
            ...
            'urlEdit' => $this->generateUrl('s_living_conditions_edit', array('id_reg'=>$region[0]->getId() )),
            'tabmenu' => $tabMenu,
    ...
    /**
     *
     * @Route("/{id_reg}/s_living_conditions/edit", name="s_living_conditions_edit")
     * @Method("GET")
    ...
    /**
     * Update data
     * @Route("/{id_reg}/s_living_conditions/update", name="s_living_conditions_update")
     * @Method("POST")
     * @Template("ncuoregion/item_edit.html.twig")
     */
    ...
    {     
        ...
        $urlAction = $this->generateUrl('s_living_conditions_update', array('id_reg'=>$region[0]->getId() ));
        $urlView = $this->generateUrl('s_living_conditions_edit', array('id_reg'=>$region[0]->getId() ));
        $urlBack = $this->generateUrl('s_living_conditions', array('id_reg'=>$region[0]->getId() ));
