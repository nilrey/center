...
class ExportController extends Controller
{
     ...
     *
     * @Route("/{id_reg}/s_export", name="s_export")
     * @Method("GET")
...
//        $sections = $em->getRepository('NCUOOivBundle:Section')->findBy(array('id_sec' => $id_reg.'__short_info'), array('view_order' => 'ASC'), null , null );
  ...
  //echo '<pre>',print_r($fields[0]),'</pre>';
        ...
        return array(
            ...
            'urlEdit' => $this->generateUrl('s_export_edit', array('id_reg'=>$region[0]->getId() )),
            'tabmenu' => $tabMenu,
    ...
    /**
     *
     * @Route("/{id_reg}/s_export/edit", name="s_export_edit")
     * @Method("GET")
    ...
    /**
     * Update data
     * @Route("/{id_reg}/s_export/update", name="s_export_update")
     * @Method("POST")
     * @Template("ncuoregion/item_edit.html.twig")
     */
    ...
    {     
        ...
        $urlAction = $this->generateUrl('s_export_update', array('id_reg'=>$region[0]->getId() ));
        $urlView = $this->generateUrl('s_export_edit', array('id_reg'=>$region[0]->getId() ));
        $urlBack = $this->generateUrl('s_export', array('id_reg'=>$region[0]->getId() ));
