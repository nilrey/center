...
class SportController extends Controller
{
    ...
    private $pageTitle = 'Физическая культура';
     ...
     *
     * @Route("/{id_reg}/s_sport", name="s_sport")
     * @Method("GET")
...
//        $sections = $em->getRepository('NCUOOivBundle:Section')->findBy(array('id_sec' => $id_reg.'__short_info'), array('view_order' => 'ASC'), null , null );
  ...
  //echo '<pre>',print_r($fields[0]),'</pre>';
        ...
        return array(
            ...
            'urlEdit' => $this->generateUrl('s_sport_edit', array('id_reg'=>$region[0]->getId() )),
            'tabmenu' => $tabMenu,
    ...
    /**
     *
     * @Route("/{id_reg}/s_sport/edit", name="s_sport_edit")
     * @Method("GET")
    ...
    /**
     * Update data
     * @Route("/{id_reg}/s_sport/update", name="s_sport_update")
     * @Method("POST")
     * @Template("ncuoregion/item_edit.html.twig")
     */
    ...
    {     
        ...
        $urlAction = $this->generateUrl('s_sport_update', array('id_reg'=>$region[0]->getId() ));
        $urlView = $this->generateUrl('s_sport_edit', array('id_reg'=>$region[0]->getId() ));
        $urlBack = $this->generateUrl('s_sport', array('id_reg'=>$region[0]->getId() ));
