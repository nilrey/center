...
class UtilitiesController extends Controller
{
    ...
    private $pageTitle = 'Коммунальное хозяйство';
     ...
     *
     * @Route("/{id_reg}/s_utilities", name="s_utilities")
     * @Method("GET")
...
//        $sections = $em->getRepository('NCUOOivBundle:Section')->findBy(array('id_sec' => $id_reg.'__short_info'), array('view_order' => 'ASC'), null , null );
  ...
  //echo '<pre>',print_r($fields[0]),'</pre>';
        ...
        return array(
            ...
            'urlEdit' => $this->generateUrl('s_utilities_edit', array('id_reg'=>$region[0]->getId() )),
            'tabmenu' => $tabMenu,
    ...
    /**
     *
     * @Route("/{id_reg}/s_utilities/edit", name="s_utilities_edit")
     * @Method("GET")
    ...
    /**
     * Update data
     * @Route("/{id_reg}/s_utilities/update", name="s_utilities_update")
     * @Method("POST")
     * @Template("ncuoregion/item_edit.html.twig")
     */
    ...
    {     
        ...
        $urlAction = $this->generateUrl('s_utilities_update', array('id_reg'=>$region[0]->getId() ));
        $urlView = $this->generateUrl('s_utilities_edit', array('id_reg'=>$region[0]->getId() ));
        $urlBack = $this->generateUrl('s_utilities', array('id_reg'=>$region[0]->getId() ));
