...
/**
 * LocalElections  controller.
 */
class LocalElectionsController extends Controller
{
    
    const SEC_ID = "s_local_elections";
    ...
    private $pageTitle = 'Выборы органов власти субъекта';
     ...
     *
     * @Route("/{id_reg}/s_local_elections", name="s_local_elections")
     * @Method("GET")
...
//        $sections = $em->getRepository('NCUOOivBundle:Section')->findBy(array('id_sec' => $id_reg.'__short_info'), array('view_order' => 'ASC'), null , null );
  ...
  //echo '<pre>',print_r($fields[0]),'</pre>';
        ...
        return array(
            ...
            'urlEdit' => $this->generateUrl('s_local_elections_edit', array('id_reg'=>$region[0]->getId() )),
            'tabmenu' => $tabMenu,
    ...
    /**
     *
     * @Route("/{id_reg}/s_local_elections/edit", name="s_local_elections_edit")
     * @Method("GET")
    ...
    /**
     * Update data
     * @Route("/{id_reg}/s_local_elections/update", name="s_local_elections_update")
     * @Method("POST")
     * @Template("ncuoregion/item_edit.html.twig")
     */
    ...
    {     
        ...
        $urlAction = $this->generateUrl('s_local_elections_update', array('id_reg'=>$region[0]->getId() ));
        $urlView = $this->generateUrl('s_local_elections_edit', array('id_reg'=>$region[0]->getId() ));
        $urlBack = $this->generateUrl('s_local_elections', array('id_reg'=>$region[0]->getId() ));
