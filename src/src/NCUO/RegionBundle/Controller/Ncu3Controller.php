 ...
 * Ncu3  controller.
 */
class Ncu3Controller extends Controller
{
    ...
    private $pageTitle = 'НЦУ/3. Сведения о численности участников регионального отделения Всероссийского детско-юношеского военно-патриотического общественного движения «ЮНАРМИЯ», количестве территориальных организаций и отрядов';
    ...
    public function showAction($id_reg)
    {
        ...
        $arResult['urlEdit'] = $this->generateUrl('ncu3_edit', array('id_reg'=>$id_reg ));
    ...
    /**
     *
     * @Route("/{id_reg}/ncu3/edit", name="ncu3_edit")
     * @Method("GET")
    ...
    /**
     *
     * @Route("/{id_reg}/ncu3/export", name="ncu3_export")
     * @Method("GET")
     * @Template("ncuoregion/item_edit.html.twig")
     */
    ...
    /**
     *
     * @Route("/{id_reg}/ncu3/import", name="ncu3_import")
     * @Method("GET")
     * @Template("ncuoregion/item_edit.html.twig")
     */
    ...
    /**
     * Update data
     * @Route("/{id_reg}/ncu3/update", name="ncu3_update")
     * @Method("POST")
     * @Template("ncuoregion/item_edit.html.twig")
     */
    ...
    {     
        ...
        $urlAction = $this->generateUrl('ncu3_update', array('id_reg'=>$region[0]->getId() ));
        $urlView = $this->generateUrl('ncu3_edit', array('id_reg'=>$region[0]->getId() ));
        $urlBack = $this->generateUrl('ncu3', array('id_reg'=>$region[0]->getId() ));
