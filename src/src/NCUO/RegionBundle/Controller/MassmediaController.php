...
/**
 * Massmedia  controller.
 */
class MassmediaController extends Controller
{
    
    const SEC_ID = "s_massmedia";
    ...
    private $pageTitle = 'Средства массовой информации';
     ...
     *
     * @Route("/{id_reg}/s_massmedia", name="s_massmedia")
     * @Method("GET")
...
//        $sections = $em->getRepository('NCUOOivBundle:Section')->findBy(array('id_sec' => $id_reg.'__short_info'), array('view_order' => 'ASC'), null , null );
  ...
  //echo '<pre>',print_r($fields[0]),'</pre>';
        ...
        return array(
            ...
            'urlEdit' => $this->generateUrl('s_massmedia_edit', array('id_reg'=>$region[0]->getId() )),
            'tabmenu' => $tabMenu,
    ...
    /**
     *
     * @Route("/{id_reg}/s_massmedia/edit", name="s_massmedia_edit")
     * @Method("GET")
    ...
    /**
     * Update data
     * @Route("/{id_reg}/s_massmedia/update", name="s_massmedia_update")
     * @Method("POST")
     * @Template("ncuoregion/item_edit.html.twig")
     */
    ...
    {     
        ...
        $urlAction = $this->generateUrl('s_massmedia_update', array('id_reg'=>$region[0]->getId() ));
        $urlView = $this->generateUrl('s_massmedia_edit', array('id_reg'=>$region[0]->getId() ));
        $urlBack = $this->generateUrl('s_massmedia', array('id_reg'=>$region[0]->getId() ));
