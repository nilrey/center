...
/**
 * Criminality  controller.
 */
class CriminalityController extends Controller
{
    
    const SEC_ID = "s_criminality";
    ...
    private $pageTitle = 'Криминогенная обстановка';
     ...
     *
     * @Route("/{id_reg}/s_criminality", name="s_criminality")
     * @Method("GET")
...
//        $sections = $em->getRepository('NCUOOivBundle:Section')->findBy(array('id_sec' => $id_reg.'__short_info'), array('view_order' => 'ASC'), null , null );
  ...
  //echo '<pre>',print_r($fields[0]),'</pre>';
        ...
        return array(
            ...
            'urlEdit' => $this->generateUrl('s_criminality_edit', array('id_reg'=>$region[0]->getId() )),
            'tabmenu' => $tabMenu,
    ...
    /**
     *
     * @Route("/{id_reg}/s_criminality/edit", name="s_criminality_edit")
     * @Method("GET")
    ...
    /**
     * Update data
     * @Route("/{id_reg}/s_criminality/update", name="s_criminality_update")
     * @Method("POST")
     * @Template("ncuoregion/item_edit.html.twig")
     */
    ...
    {     
        ...
        $urlAction = $this->generateUrl('s_criminality_update', array('id_reg'=>$region[0]->getId() ));
        $urlView = $this->generateUrl('s_criminality_edit', array('id_reg'=>$region[0]->getId() ));
        $urlBack = $this->generateUrl('s_criminality', array('id_reg'=>$region[0]->getId() ));
