 ...
 * Ncu8  controller.
 */
class Ncu8Controller extends Controller
{
    ...
    private $pageTitle = 'НЦУ/8. Перечень государственных строительных и дорожных организаций';
    ...
    public function showAction($id_reg)
    {
        ...
        $arResult['urlEdit'] = $this->generateUrl('ncu8_edit', array('id_reg'=>$id_reg ));
    ...
    /**
     *
     * @Route("/{id_reg}/ncu8/edit", name="ncu8_edit")
     * @Method("GET")
    ...
    /**
     *
     * @Route("/{id_reg}/ncu8/export", name="ncu8_export")
     * @Method("GET")
     * @Template("ncuoregion/item_edit.html.twig")
     */
    ...
    /**
     *
     * @Route("/{id_reg}/ncu8/import", name="ncu8_import")
     * @Method("GET")
     * @Template("ncuoregion/item_edit.html.twig")
     */
    ...
    /**
     * Update data
     * @Route("/{id_reg}/ncu8/update", name="ncu8_update")
     * @Method("POST")
     * @Template("ncuoregion/item_edit.html.twig")
     */
    ...
    {     
        ...
        $urlAction = $this->generateUrl('ncu8_update', array('id_reg'=>$region[0]->getId() ));
        $urlView = $this->generateUrl('ncu8_edit', array('id_reg'=>$region[0]->getId() ));
        $urlBack = $this->generateUrl('ncu8', array('id_reg'=>$region[0]->getId() ));
