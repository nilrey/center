...
class PartiesController extends Controller
{
    ...
    private $pageTitle = 'Общественно-политические партии и организации';
     ...
     *
     * @Route("/{id_reg}/s_parties", name="s_parties")
     * @Method("GET")
...
//        $sections = $em->getRepository('NCUOOivBundle:Section')->findBy(array('id_sec' => $id_reg.'__short_info'), array('view_order' => 'ASC'), null , null );
  ...
  //echo '<pre>',print_r($fields[0]),'</pre>';
        ...
        return array(
            ...
            'urlEdit' => $this->generateUrl('s_parties_edit', array('id_reg'=>$region[0]->getId() )),
            'tabmenu' => $tabMenu,
    ...
    /**
     *
     * @Route("/{id_reg}/s_parties/edit", name="s_parties_edit")
     * @Method("GET")
    ...
    /**
     * Update data
     * @Route("/{id_reg}/s_parties/update", name="s_parties_update")
     * @Method("POST")
     * @Template("ncuoregion/item_edit.html.twig")
     */
    ...
    {     
        ...
        $urlAction = $this->generateUrl('s_parties_update', array('id_reg'=>$region[0]->getId() ));
        $urlView = $this->generateUrl('s_parties_edit', array('id_reg'=>$region[0]->getId() ));
        $urlBack = $this->generateUrl('s_parties', array('id_reg'=>$region[0]->getId() ));
