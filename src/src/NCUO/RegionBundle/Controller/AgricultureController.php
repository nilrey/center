...
class AgricultureController extends Controller
{
    ...
    private $pageTitle = 'Сельское хозяйство';
     ...
     *
     * @Route("/{id_reg}/s_agriculture", name="s_agriculture")
     * @Method("GET")
...
//        $sections = $em->getRepository('NCUOOivBundle:Section')->findBy(array('id_sec' => $id_reg.'__short_info'), array('view_order' => 'ASC'), null , null );
  ...
  //echo '<pre>',print_r($fields[0]),'</pre>';
        ...
        return array(
            ...
            'urlEdit' => $this->generateUrl('s_agriculture_edit', array('id_reg'=>$region[0]->getId() )),
            'tabmenu' => $tabMenu,
    ...
    /**
     *
     * @Route("/{id_reg}/s_agriculture/edit", name="s_agriculture_edit")
     * @Method("GET")
    ...
    /**
     * Update data
     * @Route("/{id_reg}/s_agriculture/update", name="s_agriculture_update")
     * @Method("POST")
     * @Template("ncuoregion/item_edit.html.twig")
     */
    ...
    {     
        ...
        $urlAction = $this->generateUrl('s_agriculture_update', array('id_reg'=>$region[0]->getId() ));
        $urlView = $this->generateUrl('s_agriculture_edit', array('id_reg'=>$region[0]->getId() ));
        $urlBack = $this->generateUrl('s_agriculture', array('id_reg'=>$region[0]->getId() ));
