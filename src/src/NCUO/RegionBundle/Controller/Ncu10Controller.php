 ...
 * Ncu10  controller.
 */
class Ncu10Controller extends Controller
{
    ...
    private $pageTitle = 'НЦУ/10. Данные по аэродромной сети';
    ...
    public function showAction($id_reg)
    {
        ...
        $arResult['urlEdit'] = $this->generateUrl('ncu10_edit', array('id_reg'=>$id_reg ));
    ...
    /**
     *
     * @Route("/{id_reg}/ncu10/edit", name="ncu10_edit")
     * @Method("GET")
    ...
    /**
     *
     * @Route("/{id_reg}/ncu10/export", name="ncu10_export")
     * @Method("GET")
     * @Template("ncuoregion/item_edit.html.twig")
     */
    ...
    /**
     *
     * @Route("/{id_reg}/ncu10/import", name="ncu10_import")
     * @Method("GET")
     * @Template("ncuoregion/item_edit.html.twig")
     */
    ...
    /**
     * Update data
     * @Route("/{id_reg}/ncu10/update", name="ncu10_update")
     * @Method("POST")
     * @Template("ncuoregion/item_edit.html.twig")
     */
    ...
    {     
        ...
        $urlAction = $this->generateUrl('ncu10_update', array('id_reg'=>$region[0]->getId() ));
        $urlView = $this->generateUrl('ncu10_edit', array('id_reg'=>$region[0]->getId() ));
        $urlBack = $this->generateUrl('ncu10', array('id_reg'=>$region[0]->getId() ));
