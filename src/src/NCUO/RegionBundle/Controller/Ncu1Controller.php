 ...
 * Ncu1  controller.
 */
class Ncu1Controller extends Controller
{
    ...
    private $pageTitle = 'НЦУ/1. Сведения о количестве детей военнослужащих,состоящих в очереди  на получение мест в дошкольных  образовательных организациях';
    ...
    public function showAction($id_reg)
    {
        ...
        $arResult['urlEdit'] = $this->generateUrl('ncu1_edit', array('id_reg'=>$id_reg ));
    ...
    /**
     *
     * @Route("/{id_reg}/ncu1/edit", name="ncu1_edit")
     * @Method("GET")
    ...
    /**
     *
     * @Route("/{id_reg}/ncu1/export", name="ncu1_export")
     * @Method("GET")
     * @Template("ncuoregion/item_edit.html.twig")
     */
    ...
    /**
     *
     * @Route("/{id_reg}/ncu1/import", name="ncu1_import")
     * @Method("GET")
     * @Template("ncuoregion/item_edit.html.twig")
     */
...
/*        if ($request->getMethod() == "POST") {
    ...
    /**
     * Update data
     * @Route("/{id_reg}/ncu1/update", name="ncu1_update")
     * @Method("POST")
     * @Template("ncuoregion/item_edit.html.twig")
     */
            ...
            foreach( $arData as $key => $value)
            {
                ...
                try{
                    ...
                    if( !empty($entity) )
                    {
                        ...
                        $message = array(
                            'message_error' => true,
                            'message_text'  => 'Данные не сохранены.',
                            'error_explain'  => 'Данные не сохранены.',
                        );
    ...
    {     
        ...
        $urlAction = $this->generateUrl('ncu1_update', array('id_reg'=>$region[0]->getId() ));
        $urlView = $this->generateUrl('ncu1_edit', array('id_reg'=>$region[0]->getId() ));
        $urlBack = $this->generateUrl('ncu1', array('id_reg'=>$region[0]->getId() ));
