 ...
 * Ncu6  controller.
 */
class Ncu6Controller extends Controller
{
    ...
    private $pageTitle = 'НЦУ/6. Сведения об оснащенности информационно-коммуникационными системами ситуационного центра';
    ...
    public function showAction($id_reg)
    {
        ...
        $arResult['urlEdit'] = $this->generateUrl('ncu6_edit', array('id_reg'=>$id_reg ));
    ...
    /**
     *
     * @Route("/{id_reg}/ncu6/edit", name="ncu6_edit")
     * @Method("GET")
    ...
    /**
     *
     * @Route("/{id_reg}/ncu6/export", name="ncu6_export")
     * @Method("GET")
     * @Template("ncuoregion/item_edit.html.twig")
     */
    ...
    /**
     *
     * @Route("/{id_reg}/ncu6/import", name="ncu6_import")
     * @Method("GET")
     * @Template("ncuoregion/item_edit.html.twig")
     */
    ...
    /**
     * Update data
     * @Route("/{id_reg}/ncu6/update", name="ncu6_update")
     * @Method("POST")
     * @Template("ncuoregion/item_edit.html.twig")
     */
    ...
    {     
        ...
        $urlAction = $this->generateUrl('ncu6_update', array('id_reg'=>$region[0]->getId() ));
        $urlView = $this->generateUrl('ncu6_edit', array('id_reg'=>$region[0]->getId() ));
        $urlBack = $this->generateUrl('ncu6', array('id_reg'=>$region[0]->getId() ));
