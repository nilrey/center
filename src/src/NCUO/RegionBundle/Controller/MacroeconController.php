...
/**
 * Macroecon  controller.
 */
class MacroeconController extends Controller
{
    
    const SEC_ID = "s_macroecon";
    ...
    private $pageTitle = 'Макроэкономические показатели';
     ...
     *
     * @Route("/{id_reg}/s_macroecon", name="s_macroecon")
     * @Method("GET")
...
//        $sections = $em->getRepository('NCUOOivBundle:Section')->findBy(array('id_sec' => $id_reg.'__short_info'), array('view_order' => 'ASC'), null , null );
  ...
  //echo '<pre>',print_r($fields[0]),'</pre>';
        ...
        return array(
            ...
            'urlEdit' => $this->generateUrl('s_macroecon_edit', array('id_reg'=>$region[0]->getId() )),
            'tabmenu' => $tabMenu,
    ...
    /**
     *
     * @Route("/{id_reg}/s_macroecon/edit", name="s_macroecon_edit")
     * @Method("GET")
    ...
    /**
     * Update data
     * @Route("/{id_reg}/s_macroecon/update", name="s_macroecon_update")
     * @Method("POST")
     * @Template("ncuoregion/item_edit.html.twig")
     */
    ...
    {     
        ...
        $urlAction = $this->generateUrl('s_macroecon_update', array('id_reg'=>$region[0]->getId() ));
        $urlView = $this->generateUrl('s_macroecon_edit', array('id_reg'=>$region[0]->getId() ));
        $urlBack = $this->generateUrl('s_macroecon', array('id_reg'=>$region[0]->getId() ));
