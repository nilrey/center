...
/**
 * GovStructure   controller.
 */
class GovStructureController extends Controller
{
    
    const SEC_ID = "s_gov_structure";
    ...
    private $pageTitle = 'Органы государственной власти и местного самоуправления';
     ...
     *
     * @Route("/{id_reg}/s_gov_structure", name="s_gov_structure")
     * @Method("GET")
...
//        $sections = $em->getRepository('NCUOOivBundle:Section')->findBy(array('id_sec' => $id_reg.'__short_info'), array('view_order' => 'ASC'), null , null );
  ...
  //echo '<pre>',print_r($fields[0]),'</pre>';
        ...
        return array(
            ...
            'urlEdit' => $this->generateUrl('s_gov_structure_edit', array('id_reg'=>$region[0]->getId() )),
            'tabmenu' => $tabMenu,
    ...
    /**
     *
     * @Route("/{id_reg}/s_gov_structure/edit", name="s_gov_structure_edit")
     * @Method("GET")
    ...
    /**
     * Update data
     * @Route("/{id_reg}/s_gov_structure/update", name="s_gov_structure_update")
     * @Method("POST")
     * @Template("ncuoregion/item_edit.html.twig")
     */
    ...
    {     
        ...
        $urlAction = $this->generateUrl('s_gov_structure_update', array('id_reg'=>$region[0]->getId() ));
        $urlView = $this->generateUrl('s_gov_structure_edit', array('id_reg'=>$region[0]->getId() ));
        $urlBack = $this->generateUrl('s_gov_structure', array('id_reg'=>$region[0]->getId() ));
