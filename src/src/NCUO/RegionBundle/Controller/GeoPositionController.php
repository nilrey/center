...
class GeoPositionController extends Controller
{
     ...
     *
     * @Route("/{id_reg}/s_geo_position", name="s_geo_position")
     * @Method("GET")
...
//        $sections = $em->getRepository('NCUOOivBundle:Section')->findBy(array('id_sec' => $id_reg.'__short_info'), array('view_order' => 'ASC'), null , null );
  ...
  //echo '<pre>',print_r($fields[0]),'</pre>';
        ...
        return array(
            ...
            'urlEdit' => $this->generateUrl('s_geo_position_edit', array('id_reg'=>$region[0]->getId() )),
            'tabmenu' => $tabMenu,
    ...
    /**
     *
     * @Route("/{id_reg}/s_geo_position/edit", name="s_geo_position_edit")
     * @Method("GET")
    ...
    /**
     * Update data
     * @Route("/{id_reg}/s_geo_position/update", name="s_geo_position_update")
     * @Method("POST")
     * @Template("ncuoregion/item_edit.html.twig")
     */
    ...
    public function prepareEditFormData($id_reg)
    {
        ...
        $urlAction = $this->generateUrl('s_geo_position_update', array('id_reg'=>$region[0]->getId() ));
        $urlView = $this->generateUrl('s_geo_position_edit', array('id_reg'=>$region[0]->getId() ));
        $urlBack = $this->generateUrl('s_geo_position', array('id_reg'=>$region[0]->getId() ));
