...
/**
 * FederalElections  controller.
 */
class FederalElectionsController extends Controller
{
    
    const SEC_ID = "s_federal_elections";
    ...
    private $pageTitle = 'Результаты Федеральных выборов';
     ...
     *
     * @Route("/{id_reg}/s_federal_elections", name="s_federal_elections")
     * @Method("GET")
...
//        $sections = $em->getRepository('NCUOOivBundle:Section')->findBy(array('id_sec' => $id_reg.'__short_info'), array('view_order' => 'ASC'), null , null );
  ...
  //echo '<pre>',print_r($fields[0]),'</pre>';
        ...
        $tabMenu["parent_id"] = 'socio_politic'; 
        ...
        return array(
            ...
            'urlEdit' => $this->generateUrl('s_federal_elections_edit', array('id_reg'=>$region[0]->getId() )),
            'tabmenu' => $tabMenu,
    ...
    /**
     *
     * @Route("/{id_reg}/s_federal_elections/edit", name="s_federal_elections_edit")
     * @Method("GET")
    ...
    /**
     * Update data
     * @Route("/{id_reg}/s_federal_elections/update", name="s_federal_elections_update")
     * @Method("POST")
     * @Template("ncuoregion/item_edit.html.twig")
     */
    ...
    {     
        ...
        $urlAction = $this->generateUrl('s_federal_elections_update', array('id_reg'=>$region[0]->getId() ));
        $urlView = $this->generateUrl('s_federal_elections_edit', array('id_reg'=>$region[0]->getId() ));
        $urlBack = $this->generateUrl('s_federal_elections', array('id_reg'=>$region[0]->getId() ));
