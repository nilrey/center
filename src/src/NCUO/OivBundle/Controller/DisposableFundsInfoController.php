...
/**
 * DisposableFundsInfo controller.
 */
class DisposableFundsInfoController extends Controller
{
    
    const SEC_ID = "disposable_funds_info";
    private $logger;
    ...
    private $pageTitle = 'Подведомственные учреждения, силы и средства';    
     ...
     *
     * @Route("/{id_oiv}/disposable_funds_info", name="disposable_funds_info_show")
     * @Method("GET")
    ...
    public function showAction($id_oiv)
    {
        ...
        return array(
            ...
            'urlEdit' => $this->generateUrl('disposable_funds_info_edit', array('id_oiv'=>$oiv[0]->getId() )),
            'tabmenu' => $tabMenu,
     ...
     *
     * @Route("/{id_oiv}/disposable_funds_info/edit", name="disposable_funds_info_edit")
     * @Method("GET")
    ...
    /**
     * Update data 
     * @Route("/{id_oiv}/disposable_funds_info/update", name="disposable_funds_info_update")
     * @Method("POST")
     * @Template("ncuooiv/item_edit.html.twig")
     */
    ...
    public function prepareEditFormData($id_oiv, $data_to_html = false)
    {
        ...
        $urlAction = $this->generateUrl('disposable_funds_info_update', array('id_oiv'=>$oiv[0]->getId() ));
        $urlView = $this->generateUrl('disposable_funds_info_edit', array('id_oiv'=>$oiv[0]->getId() ));
        $urlBack = $this->generateUrl('disposable_funds_info_show', array('id_oiv'=>$oiv[0]->getId() ));
