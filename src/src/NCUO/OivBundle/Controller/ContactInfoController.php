...
class ContactInfoController extends Controller
{
     ...
     *
     * @Route("/{id_oiv}/contact_info", name="contact_info_show")
     * @Method("GET")
    ...
    public function showAction($id_oiv)
    {
        ...
        $arResult = $this->prepareEditFormData($id_oiv, true);
    ...
    /*
        ...
        //$urlEdit = $this->generateUrl('contact_info_edit', array('id'=>$oiv[0]->getId() ));
    ...
    */
     ...
     *
     * @Route("/{id_oiv}/contact_info/edit", name="contact_info_edit")
     * @Method("GET")
    ...
    /**
     * Update data 
     * @Route("/{id_oiv}/contact_info/update", name="contact_info_update")
     * @Method("POST")
     * @Template("ncuooiv/item_edit.html.twig")
     */
        ...
        if(count($arData) > 0 )
        {
            foreach( $arData as $key => $value)
            {
                ...
                try{
                    ...
                    $page_title = 'Контакты';
                    $this->logger->error('Ошибка сохранения данных ОИВ. Форма редактирования. Страница: '.$page_title);
                }
            }
        }
    ...
    public function prepareEditFormData($id_oiv, $data_to_html = false)
    {
        ...
        $urlAction = $this->generateUrl('contact_info_update', array('id_oiv'=>$oiv[0]->getId() ));
        $urlView = $this->generateUrl('contact_info_edit', array('id_oiv'=>$oiv[0]->getId() ));
        $urlBack = $this->generateUrl('contact_info_show', array('id_oiv'=>$oiv[0]->getId() ));
        ...
        return array(
            ...
            'urlEdit' => $this->generateUrl('contact_info_edit', array('id_oiv'=>$oiv[0]->getId() )),
            'tabmenu' => $tabMenu,
