...
/**
 * CompetenciesInfo controller.
 */
class CompetenciesInfoController extends Controller
{
    const SEC_ID = "competencies_info";
    ...
    private $pageTitle = 'Область компетенции';
     ...
     *
     * @Route("/{id_oiv}/competencies_info", name="competencies_info_show")
     * @Method("GET")
    ...
    public function showAction($id_oiv)
    {
        ...
        return array(
            ...
            'urlEdit' => $this->generateUrl('competencies_info_edit', array('id_oiv'=>$oiv[0]->getId() )),
            'tabmenu' => $tabMenu,
     ...
     *
     * @Route("/{id_oiv}/competencies_info/edit", name="competencies_info_edit")
     * @Method("GET")
    ...
    /**
     * Update data 
     * @Route("/{id_oiv}/competencies_info/update", name="competencies_info_update")
     * @Method("POST")
     * @Template("ncuooiv/item_edit.html.twig")
     */
    ...
    public function prepareEditFormData($id_oiv, $data_to_html = false)
    {
        ...
        $urlAction = $this->generateUrl('competencies_info_update', array('id_oiv'=>$oiv[0]->getId() ));
        $urlView = $this->generateUrl('competencies_info_edit', array('id_oiv'=>$oiv[0]->getId() ));
        $urlBack = $this->generateUrl('competencies_info_show', array('id_oiv'=>$oiv[0]->getId() ));
    ...
    public function checkPermsEdit($id_oiv){
        if( $this->userRoleName != 'ROLE_ADMIN' ){
            if(  $this->userRoleName != 'ROLE_FOIV'
                || ( !empty($this->idOiv) && $id_oiv !== $this->idOiv ) ){
