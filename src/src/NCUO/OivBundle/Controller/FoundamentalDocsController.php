...
/**
 * FoundamentalDocs controller.
 */
class FoundamentalDocsController extends Controller
{
    const SEC_ID = "foundamental_docs";
    private $logger;
    ...
    private $pageTitle = 'Основополагающие документы';
     ...
     *
     * @Route("/{id_oiv}/foundamental_docs", name="foundamental_docs_show")
     * @Method("GET")
    ...
    public function showAction($id_oiv)
    {
        ...
        return array(
            ...
            'urlEdit' => $this->generateUrl('foundamental_docs_edit', array('id_oiv'=>$oiv[0]->getId() )),
            'tabmenu' => $tabMenu,
     ...
     *
     * @Route("/{id_oiv}/foundamental_docs/edit", name="foundamental_docs_edit")
     * @Method("GET")
    ...
    /**
     * Update data 
     * @Route("/{id_oiv}/foundamental_docs/update", name="foundamental_docs_update")
     * @Method("POST")
     * @Template("ncuooiv/item_edit.html.twig")
     */
    ...
    public function prepareEditFormData($id_oiv, $data_to_html = false)
    {
        ...
        $urlAction = $this->generateUrl('foundamental_docs_update', array('id_oiv'=>$oiv[0]->getId() ));
        $urlView = $this->generateUrl('foundamental_docs_edit', array('id_oiv'=>$oiv[0]->getId() ));
        $urlBack = $this->generateUrl('foundamental_docs_show', array('id_oiv'=>$oiv[0]->getId() ));
