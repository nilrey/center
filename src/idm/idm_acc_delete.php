...
// $account_id ="3ece988c-9900-4575-9818-771c667ee495";
if(!empty($_GET["acc_id"])) $account_id = $_GET["acc_id"]; // Account delete id

$path = "/public/api/idm/{$set_id}/account_group/{$account_id}/";
...
try {
	...
	if ($result === false) { 
		echo "<p>Error: Account was not deleted</p>";
